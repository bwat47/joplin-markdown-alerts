...
/**
 * GitHub Octicon SVG icons for each alert type.
 * These match the icons used by markdown-it-github-alerts.
 *
 * Icons sourced from: https://github.com/primer/octicons
 */
export const ALERT_ICONS: Record<GitHubAlertType, string> = {
